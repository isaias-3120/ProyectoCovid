...
export default function SearchVacunadosScreen({navigation}) {
    ...
    async function fetchFunctionPais(pais) {
        try{
          const response = await fetch(`https://disease.sh/v3/covid-19/vaccine/coverage/countries/${pais}?lastdays=1&fullData=true`);
          const json1 = await response.json();
          if(json1.message === "No vaccine data for requested country or country does not exist")
          {
            setDatosPais()
          }
          else{
            ...
            <View style={styles.container4}>
                {
                    PaisSelec
                                ...
                                wait
                                    ...
                                    <View style={styles.container2}>
                                        ...
                                        />
                                        {
                                            ...
                                            :
                                            <Text>No hay datos para ese pais</Text>
                                        }
                        ...
                        <View style={styles.container2}>
                            ...
                            <Text>Selecciona algun pais</Text>
                        </View>
                }
            </View>
        </View>
